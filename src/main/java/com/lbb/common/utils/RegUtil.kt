...
import com.lbb.common.utils.ConstUtil.REGEX_CHZ
import com.lbb.common.utils.ConstUtil.REGEX_DATE
import com.lbb.common.utils.ConstUtil.REGEX_EMAIL
import com.lbb.common.utils.ConstUtil.REGEX_IDCARD
import com.lbb.common.utils.ConstUtil.REGEX_IDCARD15
import com.lbb.common.utils.ConstUtil.REGEX_IDCARD18
import com.lbb.common.utils.ConstUtil.REGEX_IP
import com.lbb.common.utils.ConstUtil.REGEX_MOBILE_EXACT
import com.lbb.common.utils.ConstUtil.REGEX_MOBILE_SIMPLE
import com.lbb.common.utils.ConstUtil.REGEX_TEL
import com.lbb.common.utils.ConstUtil.REGEX_URL
import com.lbb.common.utils.ConstUtil.REGEX_USERNAME
...
//        return m.matches()
        return !(cardNo.length > 19 || cardNo.length < 16)
    }
    ...
    fun isMatch(regex: String , string: String): Boolean {
        return !string.isNotEmpty() && Pattern.matches(regex , string)
    }
    ...
    fun checkPhone(phone: String): Boolean {
        val regex = "^134[0-8]\\d{7}\$|^13[^4]\\d{8}\$|^14[5-9]\\d{8}\$|^15[^4]\\d{8}\$|^16[6]\\d{8}\$|^17[0-8]\\d{8}\$|^18[\\d]{9}\$|^19[8,9]\\d{8}$"
    ...
    fun checkPswLength(psw: String): Boolean {
        return psw.length in 6..12
    }
}